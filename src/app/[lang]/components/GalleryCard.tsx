		...
		<>
			...
			{isDialogOpen && (
				<div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm">
					<div className="relative max-w-[80vw] max-h-[80vh] overflow-hidden">
						{/* Close button */}
						<button
							type="button"
							onClick={() => setIsDialogOpen(false)}
							className="absolute top-4 right-4 z-10 p-2 bg-red-800/80 hover:bg-slate-700/80 rounded-full transition-colors duration-200"
						>
