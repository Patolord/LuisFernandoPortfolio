					...
					<div className="grid lg:grid-cols-2 gap-12 items-center">
						<div>
							<h1 className="text-5xl lg:text-6xl font-bold mb-6 leading-tight">
								{dict.hero.title}
								<span className="text-sky-400 block">{dict.hero.subtitle}</span>
							</h1>
				...
				<div className="max-w-6xl mx-auto">
					...
					<div className="grid md:grid-cols-2 gap-12 items-center">
						...
						<div className="grid grid-cols-2 gap-6">
							...
							<Card className="bg-slate-800 border-slate-700">
								<CardContent className="p-6 text-center">
									<div className="text-3xl font-bold text-sky-400 mb-2">8</div>
									<div className="text-slate-300">
					...
					<div className="mb-12">
						...
						<div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
							{[
								...
								<Card key={aircraft} className="bg-slate-800 border-slate-700">
						...
						<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
							...
							<Card className="bg-slate-800 border-slate-700">
								<CardContent className="p-6">
									...
									<p className="text-slate-300 text-sm">
										{dict.expertise.specializations.certifications.description}
									</p>
								</CardContent>
							</Card>
							<Card className="bg-slate-800 border-slate-700">
